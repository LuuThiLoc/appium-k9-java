...
//
//public class BookManagementProgram_2 {
//
//    /*
...
//    }
//
//    private static void saveBookInDBWithOverwrite(Book book, String oldString, String newString) {
//
//        // WRITING
...
//        DataFactory.saveBookListOverwrite(bookListToSave, bookDataFile, oldString, newString);
//
...
//        Book oldBook = BookManagementProgram_2.findBookByISBN(iSBN, title, author, year);
//
...
//
////        saveBookInDBWithOverwrite(newBook, String.valueOf(oldBook), String.valueOf(newBook));
//        saveBookInDBWithOverwrite(newBook, String.valueOf(oldISBN), String.valueOf(newISBN));
//        saveBookInDBWithOverwrite(newBook, oldTitle, newTitle);
//        saveBookInDBWithOverwrite(newBook, oldAuthor, newAuthor);
//        saveBookInDBWithOverwrite(newBook, String.valueOf(oldYear), String.valueOf(newYear));
//    }
//
//    private static void deleteABook() {
//        Book deletedBook = BookManagementProgram_2.findBookByISBN(iSBN, title, author, year);
//        String bookDataFile = System.getProperty("user.dir").concat("\\src\\lesson_lab_13\\BookDB.txt");
//        List<Book> bookList = DataFactory.getListBookFromFile(bookDataFile);
//
...
//                saveBookInDBWithOverwrite(book, String.valueOf(deletedBook), null);
//            }
//        }
//
